              ...
              {data.map((item, i) => (
                <SwiperSlide key={i}>
                  ...
                  >
                    ...
                    >
                      <Link href={`/geo/tibbi-birimlerimiz/${item.attributes.slug}`}>
                    ...
                    <p style={{color:"#000", fontSize:15}}>{add3Dots(item.attributes.geo.text , 100)}</p>
                    </div>
