              ...
              <div className="row align-items-center">
                <div className="col-lg-12">
                  <div className="tp-blog-title-wrapper">
                    ...
                    განცხადებები <span className="title-color">&</span> ბლოგი
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div className="tp-blog-wrapper mb-30">
                  <div className="tp-blog-thumb">
                    ...
                    <div className="tp-blog-tag">
                      <p style={{ color: "#fff" }}>ანონსი</p>
                    </div>
                  </div>
                  <div className="tp-blog-content">
                    <div className="tp-blog-details "></div>
                    <h3 className="tp-blog-title">
                      <Link href={`/geo/bilgilendirme/duyurular/${item.attributes.slug}`}>{item.attributes.geo.title}</Link>
                    </h3>
                    <div className="tp-blog-btn d-flex justify-content-between">
                      <div className="read-more p-relative">
                        <Link href={`/geo/bilgilendirme/duyurular/${item.attributes.slug}`}>
                        წაიკითხეთ განცხადება{" "}
                          <span>
                            {" "}
                            <RightArrow />{" "}
                          </span>
