                ...
                <div className="col-lg-12">
                  <div className="tp-blog-title-wrapper">
                    <h3 className="tp-section-title">
                      Duyurular <span className="title-color">&</span> Blog
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div className="tp-blog-wrapper mb-30">
                  ...
                  <div className="tp-blog-content">
                    ...
                    <h3 className="tp-blog-title">
                      <Link href={`bilgilendirme/duyurular/${item.attributes.slug}`}>{item.attributes.tr.title}</Link>
                    </h3>
                    <div className="tp-blog-btn d-flex justify-content-between">
                      <div className="read-more p-relative">
                        <Link href={`bilgilendirme/duyurular/${item.attributes.slug}`}>
                          Duyuruyu Oku{" "}
                          <span>
                            {" "}
                            <RightArrow />{" "}
