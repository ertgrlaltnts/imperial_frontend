...
export default function Yazi({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"მთავარი ექიმის შეტყობინება | İmperial Hastanesi Trabzon"}
        description={
      ...
      <main>
        <Breadcrumb top_title={"მთავარი ექიმის შეტყობინება"} page_title={"მთავარი ექიმის შეტყობინება"} />
