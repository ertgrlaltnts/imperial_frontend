...
export default function Duyuru({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"განცხადებები | Imperial Hospital Trabzon"}
        description={
          "მიჰყევით იმპერიული ჰოსპიტალის მიმდინარე განცხადებებს, რომელიც გამოირჩევა ტრაპიზონის ჯანდაცვის სერვისებით. აქ არის მნიშვნელოვანი სიახლეები და ინფორმაცია ჩვენი საავადმყოფოდან."
        }
      />
      <HeaderOne data={general} />
      <main>
        <Breadcrumb top_title="განცხადებები" page_title="განცხადებები" />
        <>
                    ...
                    <div className="tp-blog-wrapper mb-30">
                      ...
                      <div className="tp-blog-content">
                        ...
                        <h3 className="tp-blog-title">
                          <Link
                            href={`/geo/bilgilendirme/duyurular/${item.attributes.slug}`}
                          >
                            {add3Dots(item.attributes.geo.title, 30)}
                          </Link>
                        </h3>
