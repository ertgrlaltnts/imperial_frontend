...
export default function Kvkk({general}){
  ...
  return (
    <Wrapper>
      <SEO
        pageTitle={"مستندات KVKK | Imperial Hospital Trabzon"}
        description={
      ...
      <main>
        <Breadcrumb top_title="مستندات KVKK" page_title="مستندات KVKK" />
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <div>
                  ...
                  Kvkk وسياسة الخصوصية
                  </h3>
                  <div className="pdf-block-title-2">
                  انقر هنا للعرض. (385 Kb)
                  </div>
            ...
            <div className="col-lg-6">
              ...
              >
                <img className="pdf-block-image" src={"/assets/main/pdf.png"} />
                <div>
                  <h3 className="pdf-block-title">جودة خاصة KVKK</h3>
                  <div className="pdf-block-title-2">
                  انقر هنا للعرض. (354 Kb)
                  </div>
                  <div className="pdf-block-title-3">
                  انقر للتحميل. (354 Kb)
                  </div>
            ...
            <div className="col-lg-6">
              ...
              >
                <img className="pdf-block-image" src={"/assets/main/pdf.png"} />
                <div>
                  <h3 className="pdf-block-title">تخزين البيانات وتدميرها</h3>
                  <div className="pdf-block-title-2">
                  انقر هنا للعرض. (385 Kb)
                  </div>
                  <div className="pdf-block-title-3">
