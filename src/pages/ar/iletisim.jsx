...
import ContactForm from "@/src/forms/contact-form-ar";
...
export default function Contact({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"اتصال | Imperial Hospital Trabzon"}
        description={
      ...
      <>
        ...
        <main>
          <Breadcrumb top_title="اتصال" page_title="اتصال" />
          <>
                  ...
                  <div className="col-lg-6">
                    <div className="tp-contact-wrapper">
                      <div className="tp-contact-title-wrapper">
                        ...
                        <p>
                        يمكنك الاتصال بنا لأي أسئلة أو تعليقات قد تكون لديك.
                        </p>
                      </div>
