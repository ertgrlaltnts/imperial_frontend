...
export default function KalitePolitikasi({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"ولادة طبيعية | Imperial Hospital Trabzon"}
        description={
          "كمستشفى إمبريال، نقدم تجربة ولادة آمنة وطبيعية للأمهات الحوامل في طرابزون. بفضل فريق الخبراء لدينا والمعدات الحديثة، نشجع الولادة الطبيعية في بيئة مريحة وداعمة، مع إعطاء الأولوية لصحة الأم والطفل. نحن هنا من أجلك من أجل بداية صحية وسلمية."
        }
      />
      <HeaderOne data={general} />
      <main>
        <Breadcrumb top_title="ولادة طبيعية" page_title="ولادة طبيعية" />
        <section
