...
export default function Duyuru({data, general}) {
  return (
    <Wrapper>
      <SEO pageTitle={`İmperial Hastanesi Trabzon | Sağlık Rehberi | ${data.tr.title}`} description={data.tr.meta_description} />
...
export async function getStaticProps({params}) {
  const response = await axios.get(
    `${process.env.NEXT_PUBLIC_IP}/api/sagliks?filters[slug][$eq]=${params.slug}&populate=deep`
  );
