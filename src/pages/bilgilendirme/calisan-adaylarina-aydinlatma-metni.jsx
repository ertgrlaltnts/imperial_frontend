...
export default function Page({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"Çalışan Adaylarına Aydınlatma Metni | İmperial Hastanesi Trabzon"}
        description={
      ...
      <main>
        <Breadcrumb
          top_title="ÇALIŞAN ADAYLARINA AYDINLATMA METNİ"
          page_title="ÇALIŞAN ADAYLARINA AYDINLATMA METNİ"
        />
