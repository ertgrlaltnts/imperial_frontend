...
export default function Duyuru({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"Duyurular | İmperial Hastanesi Trabzon"}
        description={
          "Trabzon'da sağlık hizmetleriyle öne çıkan İmperial Hastanesi'nin güncel duyurularını takip edin. Hastanemizden önemli haberler ve bilgilendirmeler burada."
        }
      />
      <HeaderOne data={general} />
      <main>
        <Breadcrumb top_title="DUYURULAR" page_title="DUYURULAR" />
        <>
                    ...
                    <div className="tp-blog-wrapper mb-30">
                      ...
                      <div className="tp-blog-content">
                        ...
                        <h3 className="tp-blog-title">
                          <Link
                            href={`/bilgilendirme/duyurular/${item.attributes.slug}`}
                          >
                            {add3Dots(item.attributes.tr.title, 30)}
                          </Link>
                        </h3>
