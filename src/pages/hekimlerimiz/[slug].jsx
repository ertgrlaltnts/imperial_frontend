...
export default function Doctor({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={`${data.name} | İmperial Hastanesi Trabzon`}
        description={
          "Trabzon'da güvenilir sağlık hizmeti sunan İmperial Hastanesi, alanında uzman hekimleriyle hastalarına en iyi tedavi olanaklarını sağlamaktadır. Hekimlerimizle tanışın."
        }
      />
