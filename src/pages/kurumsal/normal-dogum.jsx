...
export default function KalitePolitikasi({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"Normal Doğum | İmperial Hastanesi Trabzon"}
        description={
          "İmperial Hastanesi olarak, Trabzon'da anne adaylarına güvenli ve doğal bir doğum deneyimi sunuyoruz. Uzman ekibimiz ve modern donanımımızla, anne ve bebek sağlığını ön planda tutarak, konforlu ve destekleyici bir ortamda normal doğumu teşvik ediyoruz. Sağlıklı ve huzurlu bir başlangıç için yanınızdayız."
        }
      />
      <HeaderOne data={general} />
      <main>
        <Breadcrumb top_title="NORMAL DOĞUM" page_title="NORMAL DOĞUM" />
        <section
