...
export default function KalitePolitikasi({ data, general }) {
  return (
    <Wrapper>
      <SEO
        pageTitle={"Visiting Rules | Imperial Hospital Trabzon"}
        description={
      ...
      <main>
        <Breadcrumb
          top_title="ACCOMPANYING AND VISITING RULES"
          page_title="ACCOMPANYING AND VISITING RULES"
        />
...
export async function getStaticProps() {
  ...
  return {
    props: {
      data: response.data.data.attributes.visit_rules,
