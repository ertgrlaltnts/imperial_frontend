...
export default function Kvkk({general}){
  ...
  return (
    <Wrapper>
      <SEO
        pageTitle={"KVKK Documents | Imperial Hospital Trabzon"}
        description={
      ...
      <main>
        <Breadcrumb top_title="KVKK Documents" page_title="KVKK Documents" />
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <div>
                  ...
                  Click to view. (385 Kb)
                  </div>
                  <div className="pdf-block-title-3">
                  Click to download. (385 Kb)
                  </div>
                </div>
                <div>
                  <img
            ...
            <div className="col-lg-6">
              ...
              >
                <img className="pdf-block-image" src={"/assets/main/pdf.png"} />
                <div>
                  <h3 className="pdf-block-title">Special Quality KVKK</h3>
                  <div className="pdf-block-title-2">
                  Click to view. (354 Kb)
                  </div>
                  <div className="pdf-block-title-3">
                  Click to download. (354 Kb)
                  </div>
                </div>
                <div>
                  <img
            ...
            <div className="col-lg-6">
              ...
              >
                <img className="pdf-block-image" src={"/assets/main/pdf.png"} />
                <div>
                  <h3 className="pdf-block-title">Data Storage and Destruction</h3>
                  <div className="pdf-block-title-2">
                  Click to view. (385 Kb)
                  </div>
                  <div className="pdf-block-title-3">
